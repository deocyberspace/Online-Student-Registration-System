...
<form method="post">
<br>
<h3>Please input department name:</h3><br>
departmentname:<input type="text" maxlength="20" size="10" name="select">
<br><br><br>
...
try{
    ...
    String queryNumberSQL="SELECT * from course where deptname like '%"+name+"%'";
